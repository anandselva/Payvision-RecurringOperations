<?php
/**
 * File for PayvisionRecurringOperationsWsdlClass to communicate with SOAP service
 ...
 */
/**
 * PayvisionRecurringOperationsWsdlClass to communicate with SOAP service
 * 
 * @package PayvisionRecurringOperations
 * @date 2014-10-20
 * @author Anand Selvadurai
 ...
 * @version 1
 */
class PayvisionRecurringOperationsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'https://testprocessor.payvisionservices.com/Gateway/RecurringOperations.asmx?WSDL';
    /**
    ...
    /**
     * Constructor
     * @uses PayvisionRecurringOperationsWsdlClass::setLastError()
     * @uses PayvisionRecurringOperationsWsdlClass::initSoapClient()
     * @uses PayvisionRecurringOperationsWsdlClass::initInternArrayToIterate()
     * @uses PayvisionRecurringOperationsWsdlClass::_set()
     ...
     * @return PayvisionRecurringOperationsWsdlClass
     */
     ...
     * @return PayvisionRecurringOperationsWsdlClass|null
     */
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'PayvisionRecurringOperationsWsdlClass'))
            {
     ...
     * @uses PayvisionRecurringOperationsClassMap::classMap()
     * @uses PayvisionRecurringOperationsWsdlClass::getDefaultWsdlOptions()
     * @uses PayvisionRecurringOperationsWsdlClass::getSoapClientClassName()
     * @uses PayvisionRecurringOperationsWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('PayvisionRecurringOperationsClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = PayvisionRecurringOperationsClassMap::classMap();
     ...
     * If a class is named as {PayvisionRecurringOperations}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('PayvisionRecurringOperationsSoapClient') && is_subclass_of('PayvisionRecurringOperationsSoapClient','SoapClient'))
            return 'PayvisionRecurringOperationsSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses PayvisionRecurringOperationsWsdlClass::WSDL_CACHE_WSDL
     * @uses PayvisionRecurringOperationsWsdlClass::WSDL_COMPRESSION
     * @uses PayvisionRecurringOperationsWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses PayvisionRecurringOperationsWsdlClass::WSDL_ENCODING
     * @uses PayvisionRecurringOperationsWsdlClass::WSDL_EXCEPTIONS
     * @uses PayvisionRecurringOperationsWsdlClass::WSDL_FEATURES
     * @uses PayvisionRecurringOperationsWsdlClass::WSDL_LOGIN
     * @uses PayvisionRecurringOperationsWsdlClass::WSDL_PASSWORD
     * @uses PayvisionRecurringOperationsWsdlClass::WSDL_SOAP_VERSION
     * @uses PayvisionRecurringOperationsWsdlClass::WSDL_STREAM_CONTEXT
     * @uses PayvisionRecurringOperationsWsdlClass::WSDL_TRACE
     * @uses PayvisionRecurringOperationsWsdlClass::WSDL_TYPEMAP
     * @uses PayvisionRecurringOperationsWsdlClass::WSDL_URL
     * @uses PayvisionRecurringOperationsWsdlClass::VALUE_WSDL_URL
     * @uses PayvisionRecurringOperationsWsdlClass::WSDL_USER_AGENT
     * @uses PayvisionRecurringOperationsWsdlClass::WSDL_PROXY_HOST
     * @uses PayvisionRecurringOperationsWsdlClass::WSDL_PROXY_PORT
     * @uses PayvisionRecurringOperationsWsdlClass::WSDL_PROXY_LOGIN
     * @uses PayvisionRecurringOperationsWsdlClass::WSDL_PROXY_PASSWORD
     * @uses PayvisionRecurringOperationsWsdlClass::WSDL_LOCAL_CERT
     * @uses PayvisionRecurringOperationsWsdlClass::WSDL_PASSPHRASE
     * @uses PayvisionRecurringOperationsWsdlClass::WSDL_AUTHENTICATION
     * @uses PayvisionRecurringOperationsWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses PayvisionRecurringOperationsWsdlClass::getSoapClient()
     * @uses PayvisionRecurringOperationsWsdlClass::getFormatedXml()
     ...
     * @uses PayvisionRecurringOperationsWsdlClass::getSoapClient()
     * @uses PayvisionRecurringOperationsWsdlClass::convertStringHeadersToArray()
     ...
     * @uses PayvisionRecurringOperationsWsdlClass::count()
     * @return int
     */
     ...
     * @uses PayvisionRecurringOperationsWsdlClass::getInternArrayToIterate()
     * @uses PayvisionRecurringOperationsWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses PayvisionRecurringOperationsWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses PayvisionRecurringOperationsWsdlClass::getInternArrayToIterateOffset()
     * @uses PayvisionRecurringOperationsWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses PayvisionRecurringOperationsWsdlClass::getInternArrayToIterateOffset()
     * @uses PayvisionRecurringOperationsWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see PayvisionRecurringOperationsWsdlClass::offsetGet()
     * @uses PayvisionRecurringOperationsWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses PayvisionRecurringOperationsWsdlClass::getAttributeName()
     * @uses PayvisionRecurringOperationsWsdlClass::__toString()
     * @uses PayvisionRecurringOperationsWsdlClass::_set()
     * @uses PayvisionRecurringOperationsWsdlClass::_get()
     * @uses PayvisionRecurringOperationsWsdlClass::setInternArrayToIterate()
     * @uses PayvisionRecurringOperationsWsdlClass::setInternArrayToIterateIsArray()
     * @uses PayvisionRecurringOperationsWsdlClass::setInternArrayToIterateOffset()
     ...
     * @uses PayvisionRecurringOperationsWsdlClass::item()
     * @return mixed
     */
     ...
     * @uses PayvisionRecurringOperationsWsdlClass::item()
     * @uses PayvisionRecurringOperationsWsdlClass::length()
     * @return mixed
     */
