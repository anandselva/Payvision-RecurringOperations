<?php
/**
 * File for class PayvisionRecurringOperationsServiceAuthorize
 ...
 */
/**
 * This class stands for PayvisionRecurringOperationsServiceAuthorize originally named Authorize
 * @package PayvisionRecurringOperations
 * @subpackage Services
 * @date 2014-10-20
 * @author Anand Selvadurai
 ...
 * @version 1
 */
class PayvisionRecurringOperationsServiceAuthorize extends PayvisionRecurringOperationsWsdlClass
{
    /**
     ...
     * @param PayvisionRecurringOperationsStructAuthorize $_payvisionRecurringOperationsStructAuthorize
     * @return PayvisionRecurringOperationsStructAuthorizeResponse
     */
    public function Authorize(PayvisionRecurringOperationsStructAuthorize $_payvisionRecurringOperationsStructAuthorize)
    {
        try
        {
            return $this->setResult(self::getSoapClient()->Authorize($_payvisionRecurringOperationsStructAuthorize));
        }
